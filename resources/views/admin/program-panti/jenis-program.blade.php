        ...
        @section('content')
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h4 class="py-3 mb-4">
                    <span class="text-muted fw-light">Program Panti /</span> <b>Jenis Program</b>
                </h4>
                            ...
                            <div class="mt-3 mb-3">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel1">Tambah Jenis Program
                                                </h5>
                                            ...
                                            <form id="dataForm">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            <label for="nama" class="form-label">Jenis Program</label>
                                                            <input type="text" id="nama" name="nama"
                                                                class="form-control" placeholder="Jenis Program ..." />
                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel1">Edit Jenis Program
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form id="editForm">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col mb-3">
                                                            <label for="editnama" class="form-label">Jenis Program</label>
        ...
        @section('scripts')
            ...
            <script>
                $(document).ready(function() {
                    ...
                    axios.get('http://127.0.0.1:8000/api/jenis-program')
                                    ...
                                    if (row) {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                axios.delete(
                                                        `http://127.0.0.1:8000/api/jenis-program/${dataId}`
                                                    )
                                                    .then(function(response) {
                                                        // Handle success
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#editForm').submit(function(event) {
                        ...
                        $.ajax({
                            url: 'http://127.0.0.1:8000/api/jenis-program/' + idValue,
                            type: 'POST',
                            headers: {
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    dataForm.addEventListener('submit', function(event) {
                        ...
                        axios.post('http://127.0.0.1:8000/api/jenis-program', formData)
                            .then(function(response) {
                                // Handle success
